...
class CfDef:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.speculative_retry = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 43:
        if ftype == TType.LIST:
  ...
  def write(self, oprot):
    ...
    if self.speculative_retry is not None:
      ...
      oprot.writeString(self.speculative_retry)
      oprot.writeFieldEnd()
